...
const Product3 = ({ products, addToCartProduct, addToWishListProduct }) => {
  const ClickHandler = () => {
  ...
  return (
    ...
    <section className="wpo-product-section section-padding">
      <div className="container">
        <SectionTitle subTitle={'Our Shop'} MainTitle={'Special Cake For You'} />
        <div className="wpo-product-wrap">
          <div className="row">
            {products.length > 0 &&
              products.slice(12, 16).map((product, pitem) => (
